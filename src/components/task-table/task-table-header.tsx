export default function TaskTableHeader() {
  return (
    <div className='bg-background hover:bg-secondary/70 text-sm text-muted-foreground border border-border p-2 rounded-tl-md rounded-tr-md grid grid-cols-[51%,_10%,_10%,_13%,_10%,_6%]'>
      ...
      <span className='block w-ful'>Progress</span>
    </div>
  );
}
